...
var temprature_in_celcius :number=34 
var temprature_convert_to_faranhide:number=(temprature_in_celcius * 9/5)+32
...
var temprature_in_faranhide:number=114
var temprature_convert_to_celcius:number=(temprature_in_faranhide -32)*5/9
...
var achived_marks:number=340
var totalmarks:number=540
var percentage:number=(achived_marks/totalmarks)*100
...
var covert_into_days :number =days%7;
if(weeks ===0 && days ===0){
...
var user_paid_price :number=95
if(user_paid_price>100) {
    var discounted_price :number=(user_paid_price)*10/100
var final_discounted_price:number=user_paid_price-discounted_price
    console.log(`total bill after discount `,final_discounted_price);
}
else{
    var discounted_price2: number=(user_paid_price)*5/100
    var final_discounted_price2:number=user_paid_price-discounted_price2
...
//  Exwercise no 9 Develop a program that determines the day of the week. Ask the user for a number (1-7) and use nested if statements to print the corresponding day's name.
...
//  exercise no 10 Write a program that takes the number of units consumed by a user if it is greater than 100 then add 10% tax if greater than 200 then add 15% of tax so on up to if greater than 500 then add 25% of tax
// Where the tax amount will be calculated by the amount of bill.


var numberOfUnitsUsed:number=525
var pricePerUNit:number=20
if(numberOfUnitsUsed>100 && numberOfUnitsUsed<200){
    var taxPerUnit:number= (numberOfUnitsUsed*0.1);
var totalBill:number=(numberOfUnitsUsed+taxPerUnit)*pricePerUNit;
console.log(`your Total bill is ${totalBill}`);
}
else if(numberOfUnitsUsed>200 && numberOfUnitsUsed<500){
    var taxPerUnit2:number=numberOfUnitsUsed*0.15;
    var toatalBill2:number=(numberOfUnitsUsed+taxPerUnit2)*pricePerUNit;
    console.log(`your Total bill is ${toatalBill2}`);
}
else {
    var taxPerUnit3:number =numberOfUnitsUsed*2.5;
    var totalbill3:number = (numberOfUnitsUsed+taxPerUnit3)*pricePerUNit
